...
namespace Habib\Master\Migrations;
use Illuminate\Database\Migrations\MigrationCreator as MigrationCreatorAlias;
...
class MigrationCreator
{
    ...
    {
        return dirname(dirname(__DIR__)).'/stubs/base_stubs';
    }
